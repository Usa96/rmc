...
(function($) {
    ...
    function windowLoadInit() {
        ...
        var $product = $('.product');
		$product.find('.single_variation_wrap .quantity input').before('<input type="button" value="+" class="plus"><i class="fa fa-angle-up" aria-hidden="true"></i>');
		$product.find('.single_variation_wrap .quantity').append('<input type="button" value="-" class="minus"><i class="fa fa-angle-down" aria-hidden="true"></i>');
